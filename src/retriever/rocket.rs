...
impl<'a, 'r: 'a> RocketRetriever<'a, 'r> {
...
impl<'a, 'r, T> Retriever<'a, RocketRetriever<'a, 'r>, RocketRetrieverError>
...
impl<'a, 'r, T, O, B: 'r> Retriever<'a, RocketRetriever<'a, 'r>, RocketRetrieverError> for BodyRetriever<T> 
